...
def plot_dataset(datasets, distance, constraint, blacklist, method):
	...
	# plt.savefig("figures_pdf/weighted_placements_" + distance + "_" + constraint + "_" + blacklist + "_" + method + ".pdf", format='pdf', bbox_inches='tight')
	plt.savefig("figures_png/weighted_placements_" + distance + "_" + constraint + "_" + blacklist + "_" + method + ".png", format='png')
	plt.savefig("figures_svg/weighted_placements_" + distance + "_" + constraint + "_" + blacklist + "_" + method + ".svg", format='svg')
	#plt.show()
