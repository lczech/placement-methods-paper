...
def plot_dataset(consensus, datasets, distance, constraint, blacklist, method):
	...
	#plt.savefig("figures_pdf/weighted_placements_" + distance + "_" + constraint + "_" + blacklist + "_" + method + "_" + consensus + ".pdf", format='pdf', bbox_inches='tight')
	plt.savefig("figures_png/weighted_placements_" + distance + "_" + constraint + "_" + blacklist + "_" + method + "_" + consensus + ".png", format='png')
	plt.savefig("figures_svg/weighted_placements_" + distance + "_" + constraint + "_" + blacklist + "_" + method + "_" + consensus + ".svg", format='svg')
	#plt.show()
		...
		for constraint in constraints:
			# for blacklist in blacklists:
				# for method in methods:
					...
					print "Figure", plotnum, ":", consensus, distance, constraint, blacklist, method
					plt.figure( plotnum )

					plot_dataset(consensus, datasets, distance, constraint, blacklist, method)
